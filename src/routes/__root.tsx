...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Detectra AI — Digital Public Safety" },
      { property: "og:description", content: "Detect digital fraud, cyber scams and counterfeit currency with AI." },
